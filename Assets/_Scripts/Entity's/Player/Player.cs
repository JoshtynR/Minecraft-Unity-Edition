...
public class Player : BaseEntity
{
    ...
    public override void Start()
    {
        ...
        // Cache camera & remember baseline FOV
        _camComponent = cam.GetComponent<Camera>();
        _normalFOV = _camComponent.fieldOfView;
    ...
    public override void Update()
    {
        ...
        DoHeadRotation();
                ...
                // Smooth FOV shift while sprinting
        if (_camComponent != null)
        {
            float target = isSprinting ? sprintFOV : _normalFOV;
            _camComponent.fieldOfView = Mathf.Lerp(_camComponent.fieldOfView, target, Time.deltaTime * fovLerpSpeed);
        }
    ...
    private const float doubleTapThreshold = 0.3f; // seconds allowed between taps
